    ...
    module CacheBust
        class CacheDigester
            ...
            def directory_files_content
                ...
                source_files = Dir[target_path].reject { |file| File.directory?(file) }.sort
                raise "Cache-bust source directory is empty or missing: #{directory}" if source_files.empty?
